...
1. **Sign in** at the app URL your administrator gave you, using the email
   ...
   (10+ characters).
   Forgotten it? Use **Forgot your password?** on the sign-in page — you'll
   be emailed a one-time link (valid 30 minutes) to choose a new one. If no
   email arrives, an administrator can set a new password for you under
